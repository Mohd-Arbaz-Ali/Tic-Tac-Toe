...
class GamePlay implements ActionListener{
	...
	GamePlay(String s){
		...
		l1=new JLabel(new ImageIcon("xyz.jpg"));
		p=new JPanel();
	...
	public void actionPerformed(ActionEvent e){
		...
		if((e.getSource()==b1)||(e.getSource()==b2)||(e.getSource()==b3)||(e.getSource()==b4)||(e.getSource()==b5)||(e.getSource()==b6)||(e.getSource()==b7)||(e.getSource()==b8)||(e.getSource()==b9)||(e.getSource()==reset)){
			if(s1.equals("0")){
				return;
			}
			else{
